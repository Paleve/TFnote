...
class Autoencoder(object):
    def __init__(self,n_input,n_hidden,transfer_function=tf.nn.softplus,
        ...
        self.hidden = self.tranfer(tf.add(tf.matmul(self.x+scale*tf.random_normal((n_input,)),
...
def standar_scale(X_train,X_test):
...
autoencoder = Autoencoder(n_input=784,n_hidden=200,transfer_function=tf.nn.softplus,
